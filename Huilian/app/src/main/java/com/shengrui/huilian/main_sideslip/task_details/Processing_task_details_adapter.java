 ...
 */
public class Processing_task_details_adapter extends BaseDataAdapter<Processing_task_details_model> {

    private LayoutInflater mInflater;
    public Processing_task_details_adapter(List<Processing_task_details_model> datas) {
        super(datas);
    }
