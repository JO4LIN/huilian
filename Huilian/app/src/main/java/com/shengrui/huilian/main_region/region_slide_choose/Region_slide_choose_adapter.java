 ...
 */
public class Region_slide_choose_adapter extends BaseDataAdapter<Region_slide_choose_model> {
    String ss="https://ss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=1047640764,1894277665&fm=116&gp=0.jpg";
    private LayoutInflater mInflater;
    public Region_slide_choose_adapter(List<Region_slide_choose_model> datas) {
        super(datas);
    }
