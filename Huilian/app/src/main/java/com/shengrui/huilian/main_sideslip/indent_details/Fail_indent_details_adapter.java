 ...
 */
public class Fail_indent_details_adapter extends BaseDataAdapter<Fail_indent_details_model> {

    private LayoutInflater mInflater;
    public Fail_indent_details_adapter(List<Fail_indent_details_model> datas) {
        super(datas);
    }
