 ...
 */
public class Fail_task_details_adapter extends BaseDataAdapter<Fail_task_details_model> {

    private LayoutInflater mInflater;
    public Fail_task_details_adapter(List<Fail_task_details_model> datas) {
        super(datas);
    }
