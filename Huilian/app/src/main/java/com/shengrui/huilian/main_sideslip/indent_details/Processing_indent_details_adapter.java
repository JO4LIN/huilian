 ...
 */
public class Processing_indent_details_adapter extends BaseDataAdapter<Processing_indent_details_model> {

    private LayoutInflater mInflater;
    public Processing_indent_details_adapter(List<Processing_indent_details_model> datas) {
        super(datas);
    }
