 ...
 */
public class Region_slide_choose_model {
    ...
    public int getMedTypesThird() {
        return medTypesThird;
    }

    public void setMedTypesThird(int medTypesThird) {
        this.medTypesThird = medTypesThird;
    }

    public int getMedTypesFir() {
        return medTypesFir;
    }

    public void setMedTypesFir(int medTypesFir) {
        this.medTypesFir = medTypesFir;
    }
    ...
    public int getMedTypesSec() {
        return medTypesSec;
    }

    public void setMedTypesSec(int medTypesSec) {
        this.medTypesSec = medTypesSec;
    }
    ...
    int hardSimplePrice;
    boolean isOpen;
    int softMoreSecPrice;
    int readNum;
    int hardMoreSecPrice;
    int userId;
    String twoCode;
    int softMoreFirPrice;
    int medTypesSec;
    int schoolId;
    int hardMoreFirPrice;
    int softMoreOtherPrice;
    String wechatNum;
    int hardMoreOtherPrice;
