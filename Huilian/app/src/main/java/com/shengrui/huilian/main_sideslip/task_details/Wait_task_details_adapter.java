 ...
 */
public class Wait_task_details_adapter extends BaseDataAdapter<Wait_task_details_model> {

    private LayoutInflater mInflater;
    public Wait_task_details_adapter(List<Wait_task_details_model> datas) {
        super(datas);
    }
