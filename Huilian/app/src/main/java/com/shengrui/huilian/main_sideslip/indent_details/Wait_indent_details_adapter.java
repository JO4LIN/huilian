 ...
 */
public class Wait_indent_details_adapter extends BaseDataAdapter<Wait_indent_details_model> {

    private LayoutInflater mInflater;
    public Wait_indent_details_adapter(List<Wait_indent_details_model> datas) {
        super(datas);
    }
