 ...
 */
public class Accomplish_task_details_adapter extends BaseDataAdapter<Accomplish_task_details_model> {

    private LayoutInflater mInflater;
    public Accomplish_task_details_adapter(List<Accomplish_task_details_model> datas) {
        super(datas);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       // holder.media_id.setText(String.valueOf(datas.get(position).getMediaId()));
        holder.mediaName.setText(datas.get(position).getUserName());
        ...
        ImageLoader.getInstance().displayImage( datas.get(position).getUserHead(), holder.mediaHead);
        return convertView;
    }
