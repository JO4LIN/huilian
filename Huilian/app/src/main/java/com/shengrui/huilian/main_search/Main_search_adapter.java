 ...
 */
public class Main_search_adapter extends BaseDataAdapter<Main_search_model> {

    private LayoutInflater mInflater;
    public Main_search_adapter(List<Main_search_model> datas) {
        super(datas);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       // 配置图片加载及显示选项（还有一些其他的配置，查阅doc文档吧）
        ...
        if (convertView == null) {
            ...
            holder.mediaHead= (ImageView) convertView.findViewById(R.id.media_pic);
            holder.mediaName= (TextView) convertView.findViewById(R.id.media_name);
            holder.price=((TextView) convertView.findViewById(R.id.subscription_price));
            holder.readNum=((TextView) convertView.findViewById(R.id.media_readingnum));
            holder.fansNum=((TextView) convertView.findViewById(R.id.media_fansnum));
            holder.mediaId=((TextView) convertView.findViewById(R.id.media_id));
            holder.subscription_verification=((ImageView) convertView.findViewById(R.id.subscription_verification));
        ...
        if(datas.get(position).getIsVerification()){
            holder.subscription_verification.setBackgroundResource(R.drawable.icon_verification_green);
        }else{
            holder.subscription_verification.setBackgroundResource(R.drawable.icon_verification);
        }
    ...
    public final class ActiveViewHolder implements ViewHolder {
        ...
        private ImageView subscription_verification = null;
        ...
        public ImageView getSubscription_verification() {
            return subscription_verification;
        }

        public void setSubscription_verification(ImageView subscription_verification) {
            this.subscription_verification = subscription_verification;
        }
    }
